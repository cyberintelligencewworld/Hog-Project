...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    num = score**3
    i , k , overall_score = length_of_digit(num) , -1 , 0
    while i > 0:
        k , p , num = -k , num // (10**(i-1)), num % (10**(i-1))
        if i == 1 and p==0:
            overall_score = overall_score + k * y
            break
        overall_score = overall_score + k * p
        y = num
        i -=1
    return 1 + abs(overall_score)
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    last_digit = temp % 10
    first_digit = temp // (10 ** (length_of_digit(temp)-1))
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            ...
            score0 = score0 + take_turn(dice0, score1, dice)
        else:
            dice1 = strategy1(score1, score0)
            score1 = score1 + take_turn(dice1, score0, dice)
...
#         return 2
#     return 6
# s0, s1 = play(strat0, strat1, score0=0, score1=0, goal=21,dice=make_test_dice(2, 2, 3, 4, 2, 2, 2, 2, 2, 3, 5, 2, 2, 2, 2, 2, 2, 2, 6, 1))
# print(s0) 
# print(s1)
